...
public class JwtProvider {
    ...
    // 토큰 생성
    public String createToken(String email, UserRoleEnum role, Long tokenTime, String name, String gender) {
        Date date = new Date();
    ...
    public String createAccessToken(String email, UserRoleEnum role, String name, String gender) {
        return this.createToken(email, role, ACCESS_TOKEN_TIME, name, gender);
    }

    public String createRefreshToken(String email, UserRoleEnum role, String name, String gender) {
    ...
    public String createAccessTokenFromRefreshToken(Claims refreshInfo) {
        ...
        String gender = refreshInfo.get(GENDER_KEY, String.class);
